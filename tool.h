...
typedef struct
{
    ...
    int lSNum;//the number of left servers after closing some servers
    ...
    int mSNumPerVar;//divide one variable into mSNumPerVar shares (=choose t from m-t) after merging
